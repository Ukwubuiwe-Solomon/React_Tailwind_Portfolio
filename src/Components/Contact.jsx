  ...
  return (
    ...
    from-black to-gray-800 p-4 text-white'>
        ...
        max-w-screen-lg mx-auto h-full'>
            <div className='pb-8'>
                <p className='text-4xl font-bond inline border-b-4 border-gray-500'>Contact</p>
                <p className='py-6'>Submit the form below to get in touch with me</p>
            </div>
            <div className='flex justify-center items-center'>
                <form action="https://getform.io/f/7a10ca49-f478-4d6e-adc2-feb1f3483738" method="POST" className='flex flex-col
                w-full md:w-1/2'>
                    ...
                    rounded-md text-white focus:outline-none'/>
                    <textarea name="message" rows="10" placeholder='Enter your message' className='p-2 bg-transparent
                    border-2 rounded-md text-white
                    focus:outline-none' ></textarea>
                    <button className='mt-4 text-white bg-gradient-to-b
